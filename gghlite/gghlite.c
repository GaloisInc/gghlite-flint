...
void
_gghlite_sk_sample_a(gghlite_sk_t self, aes_randstate_t randstate)
{
    /* assert(self->D_g); */
...
void
_gghlite_sk_set_y(gghlite_sk_t self)
{
...
void
_gghlite_sk_sample_b(gghlite_sk_t self, aes_randstate_t randstate)
{
/*     assert(self->params); */
...
void
_gghlite_sk_set_x(gghlite_sk_t self)
{
    /* fmpz_mod_poly_t tmp; */
    /* fmpz_mod_poly_init(tmp, self->params->q); */
